...
class examedit_form extends moodleform
{
    public function definition()
    {
        ...
        $mform->addElement(
            'header',
            'exameditformheader',
            get_string('exameditformheader', 'local_examdelay')
        );
        ...
        $mform->addElement(
            'submit',
            'editsubmit',
            get_string('submitexamparentedit', 'local_examdelay')
        );
        ...
        $mform->setExpanded('exameditformheader', false);
    }
