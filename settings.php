...
if ($hassiteconfig) {
    ...
    $page->add(new admin_setting_configtext('local_examdelay/examdelay',
    ...
    $page->add(new admin_Setting_configselect('local_examdelay/period',
                                                get_string('period', 'local_examdelay'),
                                                get_string('period_desc', 'local_examdelay'),
                                                '86400',
                                                $periods));
